                              ...
                              if (response.statusCode == 200) {
                                ...
                                setState(() {
                                  ...
                                  if (P311BP12BALANCE03CALVAR
                                    ...
                                    if ((P311BP12BALANCE03CALVAR.targetValue10 >
                                                0 &&
                                            P311BP12BALANCE03CALVAR
                                                    .targetValue10 <
                                                199.9990) ||
                              ...
                              if (response.statusCode == 200) {
                                ...
                                setState(() {
                                  ...
                                  if (P311BP12BALANCE03CALVAR
                                    ...
                                    if ((P311BP12BALANCE03CALVAR.targetValue11 >
                                                0 &&
                                            P311BP12BALANCE03CALVAR
                                                    .targetValue11 <
                                                199.9990) ||
                    ...
                    ElevatedButton.icon(
                      onPressed: () {
                        ...
                        if (P311BP12BALANCE03CALVAR.button1PressCount > 1 &&
                            ...
                            P311BP12BALANCE03CALVAR.button8PressCount > 1 &&
                            P311BP12BALANCE03CALVAR.button9PressCount > 1 &&
                            P311BP12BALANCE03CALVAR.button10PressCount > 1 &&
                            P311BP12BALANCE03CALVAR.button11PressCount > 1 &&
                            P311BP12BALANCE03CALVAR.button12PressCount > 1) {
                          P311BP12BALANCE03CALMAINcontext.read<
                                  P311BP12BALANCECALDATA_Bloc>()
                              .add(P311BP12BALANCECALDATA_GET());
                          Navigator.of(P311BP12BALANCE03CALMAINcontext).pop();
                          // P300CALMAINcontext.read<
                          //         P300BP12BALANCEGETCALDATA_Bloc>()
                          //     .add(P300BP12BALANCEGETCALDATA_Bloc_GET());
                          // แสดงข้อความแจ้งเตือนที่มุมขวาบน
                          ...
                          // ถ้าค่าของ buttonCondition ไม่เป็น 1 (เช่น เป็น 0) ปุ่มไม่ทำอะไร
                          print(
                              "Button is disabled because condition is not met.");
                        }
                      },
                      ...
                      onLongPress: P311BP12BALANCE03CALVAR.averageValue == 0
                          ? null
